...
- The learner's stable direction is to express everyday real contexts in English. Topic clusters such as embodied AI or product building are contexts, never inferred personal goals. Switching topics only filters the candidate inbox and must not rewrite the header direction or erase cross-topic learning history.
